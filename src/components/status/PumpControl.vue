<template>
  ...
  <ion-list
    v-if="bombaNoMomento == 0 && nivelNoMomento < 3 && contraSecoNoMomento == 1"
    class="ion-padding"
  >
...
<script>
import { IonList, IonCardHeader, IonCardTitle, IonButton } from "@ionic/vue";
export default {
  props: ["nivelNoMomento", "contraSecoNoMomento", "bombaNoMomento"],
  components: {
    IonList,
    IonCardHeader,
    IonCardTitle,
